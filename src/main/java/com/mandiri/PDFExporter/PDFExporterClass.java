...
public class PDFExporterClass {
    public void exportToPdf() throws IOException {
        ...
        topSidePDF(document, totalTransaction, datePay, d_Fortmat, pageWidth, pageHeight, contentStream, textClass, font);
        ...
        textClass.addMultiLineText(paymentMethod, 15, 25, 180,
        ...
        textClass.addSingleLineText(bottomLine, (int) (pageWidth - bottomLineWidth) / 2, 50, italicFont, 20, Color.DARK_GRAY);
    ...
    private void topSidePDF(PDDocument document, Integer totalTransaction, String datePay, Format d_Fortmat, int pageWidth, int pageHeight, PDPageContentStream contentStream, TextClass textClass, PDFont font) throws IOException {
        ...
        textClass.addSingleLineText(titleLine, (int) (pageWidth - titleLineWidth) / 2, pageHeight - 150, font, 20, Color.BLACK);
        textClass.addSingleLineText("Total Transaksi: " + totalTransaction, 25, pageHeight - 274, font, 16, Color.BLACK);

        float dateTextWidth = textClass.getTextWidth("Date: " + d_Fortmat.format(new Date()), font, 16);
        textClass.addSingleLineText("Date: " + datePay, (int) (pageWidth - 67 - dateTextWidth),
                pageHeight - 274, font, 16, Color.BLACK);
    }

    private void tableAddCell(PDDocument document, int pageHeight, PDPageContentStream contentStream, PDFont font) throws IOException {
